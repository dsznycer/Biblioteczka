...
BookState _$BookStateFromJson(Map<String, dynamic> json) => BookState(
      ...
      recomendedBooks: (json['recomendedBooks'] as List<dynamic>?)
              ...
              .toList() ??
          const [],
      recomendedBooksOfMonth: (json['recomendedBooksOfMonth'] as List<dynamic>?)
              ?.map((e) => BookApi.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      ...
      choosenBookApi: json['choosenBookApi'] == null
          ? null
          : BookApiModel.fromJson(
              json['choosenBookApi'] as Map<String, dynamic>),
...
Map<String, dynamic> _$BookStateToJson(BookState instance) => <String, dynamic>{
      ...
      'recomendedBooksOfMonth':
          instance.recomendedBooksOfMonth.map((e) => e.toJson()).toList(),
      ...
      'choosenBookApi': instance.choosenBookApi?.toJson(),
